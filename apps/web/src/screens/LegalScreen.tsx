...
export const PRIVACY = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'You can download a copy of your data anytime (Settings → Export my data), edit your display name, delete individual tributes, or delete your entire account (Settings → Delete account). Under GDPR Articles 15 and 17, EU residents have the right of access and erasure. Under CCPA §1798.100/.105, California residents have the same rights. Write to support@gethaloframe.com for help.',
    },
    {
    ...
    {
      heading: 'Contact',
      body: 'Privacy questions, data requests, or concerns: support@gethaloframe.com. We respond to every message within 5 business days.',
    },
  ],
};
...
export const TERMS = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Subscriptions bill monthly or annually and AUTO-RENEW at the end of each period at the then-current price unless cancelled at least 24 hours before renewal. Manage or cancel anytime: iOS — Settings → [your name] → Subscriptions; Android — Play Store → Subscriptions; Web — contact support@gethaloframe.com. Your existing tribute allowance stays active through the end of the current period. Canvas orders are custom-made; we can’t accept returns, but we will reprint free of charge if the item arrives damaged or materially different from the preview. Contact support@gethaloframe.com within 14 days for reprints.',
    },
    {
    ...
    {
      heading: 'Contact',
      body: 'Questions about these terms: support@gethaloframe.com.',
    },
  ],
};
